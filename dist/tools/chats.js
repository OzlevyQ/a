...
export async function getChats(args) {
    try {
...
export async function getChatInfo(args) {
    try {
        const connectionCheck = await checkWhatsAppConnection();
        if (!connectionCheck.isConnected) {
            return {
...
export async function clearMessages(args) {
    try {
        const connectionCheck = await checkWhatsAppConnection();
        if (!connectionCheck.isConnected) {
            return {
