...
`;
  ...
  public async smartConnect(): Promise<void> {
...
let whatsAppConnectionInstance: WhatsAppConnectionManager | null = null;

export function getWhatsAppConnection(): WhatsAppConnectionManager {
...
export const whatsAppConnection = new Proxy({} as WhatsAppConnectionManager, {
  get(target, prop) {
